...
//   cardPrice.innerHTML = `<span>$</span> ${val["price"]}`;
...
//   card.append(cardImg, cardTitle, cardSubtitle, cardDivider, cardFooter);
...
buttonTextSpan.innerText = "Seemore";
...
// document.body.appendChild(cartButton);
  ...
  // cardFooter.appendChild(cardPrice);
  // cardFooter.appendChild(cardBtn);
buttondiv.append(uiverseButton,cartButton)
  card.append(cardImg,cardTitle,cardPrice,discountPercentage,brand,cardDivider,buttondiv);
